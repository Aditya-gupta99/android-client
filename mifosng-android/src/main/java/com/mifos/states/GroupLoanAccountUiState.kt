...
sealed class GroupLoanAccountUiState {
    ...
    data class ShowGroupLoanTemplate(val groupLoanTemplate: GroupLoanTemplate) : GroupLoanAccountUiState()

    data class ShowGroupLoansAccountCreatedSuccessfully(val loans: Loans) : GroupLoanAccountUiState()

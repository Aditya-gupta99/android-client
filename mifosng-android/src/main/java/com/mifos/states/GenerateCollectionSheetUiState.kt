...
sealed class GenerateCollectionSheetUiState {
    ...
    data class ShowStaffInOffice(val staffs: List<Staff>, val officeId: Int) : GenerateCollectionSheetUiState()
    ...
    data class ShowGroupByCenter(val centerWithAssociations: CenterWithAssociations) : GenerateCollectionSheetUiState()

    data class OnCenterLoadSuccess(val centerDetails: List<CenterDetail>) : GenerateCollectionSheetUiState()

    data class ShowProductive(val collectionSheetResponse: CollectionSheetResponse) : GenerateCollectionSheetUiState()

    data class ShowCollection(val collectionSheetResponse: CollectionSheetResponse) : GenerateCollectionSheetUiState()
}